...
describe('calculateDueDate', () => {
  ...
  describe('Calculate target date within week', () => {
    it('should calculate target date for the next day', () => {
      assert.equal(calculateDueDate(new Date(2018, 8, 17, 9), 10).getTime(), new Date(2018, 8, 18, 11).getTime())
    })

    it('should calculate target date for the day following next day', () => {
      assert.equal(calculateDueDate(new Date(2018, 8, 17, 13), 16).getTime(), new Date(2018, 8, 19, 13).getTime())
    })
  })

  describe('Calculate target date skipping weekend', () => {
    it('should calculate target date for the next week', () => {
      assert.equal(calculateDueDate(new Date(2018, 8, 21, 13), 8).getTime(), new Date(2018, 8, 24, 13).getTime())
    })
    ...
    it('should calculate target date for the week following next week', () => {
      ...
      assert.equal(calculateDueDate(new Date(2018, 8, 21, 16), 42).getTime(), new Date(2018, 9, 1, 10).getTime())
    })
  })
})